...
if __name__=="__main__":
    datapath='data/2024_LLMRAG_smartfactory/'
    ...
    for i in data_list:
        ...
        res[i.split("/")[-1]] = decoded_string
        print(i)

    with open(f'data/smart_factory.jsonl','w+') as f:
    ...
    print(f["TSMC_2021_sustainabilityReport_chinese_c-all.pdf"])
